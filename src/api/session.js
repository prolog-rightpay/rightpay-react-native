...
export class RightPayAPISession {
    ...
    colorForPaymentMethod = (m) => {
        var id = m.id
        var issuerId = m.issuer_id
        if (m.payment_method) {
            id = m.payment_method.id
            if (m.payment_method.issuer) {
                issuerId = m.payment_method.issuer.id
            }
        }
        if (id == "a09ef51d-25dd-4a46-95cd-a23cf6a3cb4b") {
            //plat
            return "#949494"
        } else if (id == "74ffa306-1832-44c5-a2f4-6769ea69fb14") {
            //gold
            return "#FFDA5D"
        } else if (id == "2176ac69-eb95-44b9-b855-f4092ed220ef" || id == "193dc079-f5ca-41cc-9523-b72094210625") {
            // amex blue cash
            return "#293A62"
        } else if (id == "42abd04c-e86c-4049-9fdd-a1e03e9db947") {
            // chase freedom
            return "#639AFF"
        } else if (issuerId == "fe363431-58d4-478c-a4a3-4bd9a51b1179") {
            // capital one
            return "#2B2B2B"
        } else if (issuerId == "522703c1-00a0-421f-b1d7-d7da77be2b81") {
            // boa
            return "#FF4C4C"
        } else if (issuerId == "5fcd6109-098e-439d-a414-50aa08bf5786") {
            // citi
            return "#014684"
        } else if (issuerId == "b932c1a8-2adf-495f-9936-f1416ccce70e") {
            // discover
            return "#F68221"
        } else if (issuerId == "ce6dd56d-f6a5-46cf-b558-956de3102922") {
            // wells fargo
            return "#D71E28"
        } else if (issuerId == "71a73963-1d00-478f-9185-786f21b6e898") {
            // us bank
            return "#112379"
        } else {
            return "#639AFF"
